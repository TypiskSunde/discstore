    ...
    <div class="card" id="item1">
        ...
        <div class="title">Signatur<br>Jeremy Koling Thunderbird</div>
        <br>
        <div>
        <label>Pris: 299kr</label>
                    <br>
...
<div class="container1">
    <div class="card" id="item2">
        <img src="bilder/bilde4.jpg">
        <div class="title">Signatur<br>Paul Mcbeth Buzz</div>
        <br>
        <div>
            <label>Pris: 299kr</label>
                    <br>
...
<div class="container2">
    <div class="card" id="item3">
        <img src="bilder/bilde5.jpg">
        <div class="title">Signatur<br>PDX</div>
        <br>
        <div>
            <label>Pris: 299kr</label>
                    <br>
...
<div class="container3">
    <div class="card" id="item4">
        <img src="bilder/bilde6.jpg">
        <div class="title">Signatur<br>Ricky Wysocki Harp</div>
        <br>
        <div>
            <label>Pris: 299kr</label>
                    <br>
